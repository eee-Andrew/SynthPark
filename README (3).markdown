...
- Clone the repository locally:
  ```bash
  git clone https://github.com/eee-Andrew/SynthPark.git
  cd SynthPark
  ```

### 2. Verify the License
- Ensure `LICENSE.md` is in the root directory of the `main` branch (not in a subdirectory).
- If missing, add it:
  ```bash
  echo "MIT License\n\nCopyright (c) 2025 eee-Andrew\n\nPermission is hereby granted..." > LICENSE.md
  git add LICENSE.md
...
├── LICENSE.md                # MIT License (should be in the root)
...
## License
This project is licensed under the [MIT License](LICENSE.md), making it free and open for development, modification, and distribution. Feel free to contribute and build upon this work!
...
🐛 Report issues or contribute at [GitHub Issues](https://github.com/eee-Andrew/SynthPark/issues).